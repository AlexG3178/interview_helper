...
class InterviewAssistant:
   ...
   def generate_answer(self, question):
       ...
       try:
           ...
           self.populate_questions_and_answers()  # Refresh UI
       except Exception as e:
           print(f"Error generating answer: {e}")
           self.answers.append("Error generating answer.")
           self.populate_questions_and_answers()  # Handle errors
   ...
   def populate_questions_and_answers(self):
       ...
       if self.selected_index is not None:
           if self.selected_index == len(self.questions) - 1:
               # If the last question was selected, auto-select the new last question
   ...
   def on_question_select(self, event):
       ...
       if selected_question_index:
           self.selected_index = selected_question_index[0]  # Track the selected index
           self.ui.highlight_answer(self.selected_index, self.answers)  # Highlight the answer
